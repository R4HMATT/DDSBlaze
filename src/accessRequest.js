...
let Connections = require('./Connection.json');
  ...
  var applicationConfig = {
        ...
        authority: `https://login.microsoftonline.com/bdcc68fe-2692-4c7a-b7fe-ca9ff4385193/oauth2/authorize?client_id=${Connections.sharepoint.client_id}&response_type=id_token+token&scope=openid&redirect_uri=https://localhost:3000/&state=12345&nonce=random&response_mode=form_post`,
        ...
        spendpoint: Connections.sharepoint.list_address
